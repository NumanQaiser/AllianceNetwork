        ...
        <section id="contact" className="contact">
                    <div className="container" data-aos="fade-up">
                        <div className="section-title">
                            ...
                            <p className='font-weight-bold'>Its an pleasure for us  that you are intrested to contact with us .Feel free to send us message and always available for you :)</p>
                        </div>
                        <div className="row">
                            <div className="col-lg-5 d-flex align-items-stretch">
                                <div className="info">
                                    ...
                                    <div className="email">
                                        ...
                                        <h4>Email:</h4>
                                        <p>support@alliancenetworkcorp.com
