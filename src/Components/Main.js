        ...
        <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay={200}>
                            <h1>Better Solutions For Your Network</h1>
                            <h2>We have large Network of talented peoples and minds</h2>
            ...
            <main id="main">
                ...
                <section id="clients" className="clients section-bg">
                    <div>
                        <h1>To whom With We Deal?</h1>
                        <p><strong>we are working with these high profile companies around the glob</strong></p>
                    </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row" data-aos="zoom-in">
                            ...
                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src="assets/img/clients/at.jpeg" className="img-fluid" alt="" />
                            </div>
                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src="assets/img/clients/century.jpeg" className="img-fluid" alt="" />
                            </div>
                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src="assets/img/clients/viasat.jpeg" className="img-fluid" alt="" />
                            </div>
                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src="assets/img/clients/spectrum.jpeg" className="img-fluid" alt="" />
                            </div>
                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src="assets/img/clients/optimum.jpeg" className="img-fluid" alt="" />
                            </div>
                            <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                                <img src="assets/img/clients/finity.jpeg" className="img-fluid" alt="" />
                            </div>
                            {/* <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                ...
                <section id="about" className="about">
                    <div className="container" data-aos="fade-up">
                        ...
                        <p>
                                    When Alliance Network was established back in 2014, we had a vision to provide high quality Customer Acquisition Solutions at economical rates.

                                    And in the short time span of three years we have been able to secure a Clientele comprised of some of the most influential organisations from around the globe.

                                    With our team of experts we have managed to direct customer attention to our clients by securing advertisement in the leading search engines and other providers. Once we have captured the attention we very carefully lead potential customers to a website or sale center where interested customers can purchase the offered services or products.
                                </p>
                            {/* <div className="col-lg-6">
                                <p>
                                    When Systec Telecom was established back in 2014, we had a vision to provide high quality Customer Acquisition Solutions at economical rates.
                ...
                <section id="services" className="services section-bg">
                    <div className="container" data-aos="fade-up">
                        <div className="section-title">
                            <h2>Services</h2>
                            <p>Systec Telecom implements a Technology Platform that is capable of catering a Wide Range of Industry Standards. Each area is supported by a dynamic and experienced team of professionals to assist us on the specific concepts. Our Digital Marketing Strategy makes use of the following:-</p>
                        </div>
                        <div className="row">
                            <div className="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={100}>
                                <div className="icon-box">
                                    <div className="icon"><i className="bx bxl-dribbble" /></div>
                                    <h4><a href>Paid Search Targeting</a></h4>
                                    <p>Our technology allows the constant monitoring of the position of targets due to which Systec Telecom is always in the best state .</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay={200}>
                                <div className="icon-box">
                                    <div className="icon"><i className="bx bx-file" /></div>
                                    <h4><a href>Dynamic Landing Pages:</a></h4>
                                    <p>Our Landing pages are capable of adapting to the needs of the visitors so that they see only relevant information.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay={300}>
                                <div className="icon-box">
                                    <div className="icon"><i className="bx bx-tachometer" /></div>
                                    <h4><a href>Data Capture Technology</a></h4>
                                    <p>Our Data Capture Technology gives us the ability to properly understand the customer base.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay={400}>
                                <div className="icon-box">
                                    <div className="icon"><i className="bx bx-layer" /></div>
                                    <h4><a href>Technology for Retargeting</a></h4>
                                    <p>It is important to retarget the interested customers especially based on their previous experiences with our technology assets.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container" data-aos="zoom-in">
                        <div className="row">
                            <div className="col-lg-9 text-center text-lg-start">
                                ...
                                <p>Hey buddy ! i hope you will be into good mode and health .Now its a time for business if you wanted take my services so don't be shy just click and kick off </p>
                            </div>
                            <div className="col-lg-3 cta-btn-container text-center">
                                <NavLink to="/contact"><a className="cta-btn align-middle" href="#">Call To Action</a></NavLink>
                            </div>
                        </div>
                    </div>
                ...
                <section id="team" className="team section-bg">
                    <div className="container" data-aos="fade-up">
                        <div className="section-title">
                            <h2>Management</h2>
                            <p>Mangement one of the best thing is to work like team even the most difficult task become easier .Management is aessential part in every organization in order to successed.</p>
                        </div>
                        <div className="row">
                            <div className="col-lg-6">
                        ...
                        <div className="faq-list">
                            <ul>
                                <li data-aos="fade-up" data-aos-delay={100}>
                                    <i className="" /> <a data-bs-toggle="collapse" className="collapse" data-bs-target="#faq-list-1">What we do ? <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                                    <div id="faq-list-1" className="collapse show" data-bs-parent=".faq-list">
                                        <p>
                                        We lower the bill for cable ,internet and phone services on customer's behalf.We deal with all top american cable companies like .
AT&T,Spectrum,Viasat,Comcast,Centurylink,Optimum,media com.
                                        </p>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay={200}>
                                    <i className="" /> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" className="collapsed">Where our head office is ?<i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                                ...
                                <li data-aos="fade-up" data-aos-delay={300}>
                                    <i className="" /> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" className="collapsed">How much can lower the cable bill? <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                                    <div id="faq-list-3" className="collapse" data-bs-parent=".faq-list">
                                        <p>
                                        Discount varies from location to location , u can call xyz no to get quote
                                        </p>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay={400}>
                                    <i className="" /> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" className="collapsed">Why Choose Us <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                                    <div id="faq-list-4" className="collapse" data-bs-parent=".faq-list">
                                        <p>
                                            we are best in the market that you can not compare us with others .we have been working in this field since long time.so feel free to talk with us.
                                        </p>
                                    </div>
                                </li>
                                <li data-aos="fade-up" data-aos-delay={500}>
                                    <i className="" /> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" className="collapsed">How to reach us? <i className="bx bx-chevron-down icon-show" /><i className="bx bx-chevron-up icon-close" /></a>
                                    <div id="faq-list-5" className="collapse" data-bs-parent=".faq-list">
                                        <p>
                                            Just click here to reach US!
